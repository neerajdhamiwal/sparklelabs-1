    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <div class="page-url"><label>Page URL : </label><div class="myurl"><?php echo $_SERVER['HTTP_HOST'] . request_uri(); ?></div></div>
  ...
  jQuery(function($) {
    ...
    $("#myEmailModal .send-mail-btn").click(function( event ) {
      if($('#mail-from').val() == "" || $('#mail-to').val() == "" ){
        ...
        var data = "from="+from+"&to="+to+"&subject="+subject_enc+"&message="+message_enc+"&page_title="+page_title_enc+"&site_email="+site_email+"&page_url="+page_url;
