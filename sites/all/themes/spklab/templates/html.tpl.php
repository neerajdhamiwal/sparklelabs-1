...
<head>
    <link rel="stylesheet" href="https://use.typekit.net/roh2jgb.css">

  <link rel="profile" href="<?php print $grddl_profile; ?>" />
  <link rel="faicons" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.css" />
  ...
  <![endif]-->
  <?php print $scripts; ?>
  <script type='text/javascript' src='//platform-api.sharethis.com/js/sharethis.js#property=598ad4dfea00a30012ce66bc&product=custom-share-buttons' async='async'>
  </script>
</head>
