...
foreach ($rows as $row_count => $row): ?>
    ...
    $node = node_load($nid);
    ?>
    <div class="main-item2 col-sm-4  p-0">
                    ...
                    <div class="col-sm-12 p-0">
                      <div class="product-title col-sm-9 p-0">
                        ...
                        <div class="product-price col-sm-3 p-0">
                            <?php if ($node->field_add_ons_accessories_refere['und'][0]['product_id']) {
                                if (commerce_product_load($node->field_add_ons_accessories_refere['und'][0]['product_id'])->commerce_price['und'][0]['amount']) {
                                    $product = commerce_product_load($node->field_add_ons_accessories_refere['und'][0]['product_id']);
