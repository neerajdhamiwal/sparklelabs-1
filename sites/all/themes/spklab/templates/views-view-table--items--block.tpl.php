...
$counter = 0;
echo'<div class="main-item col-sm-4  p-0"><div class="slider-main col-sm-12">';
        ...
        if(isset($node->field_images_and_videos['und'])) {
            foreach ($node->field_images_and_videos['und'] as $img_content) {
                ...
                $file = file_load($fid);
                if ($counter == 0) {
                    echo '<div id="image-area_' . $r . '_' . $counter . '" class="tab-pane fade in active">';
                } else {
                    echo '<div id="image-area_' . $r . '_' . $counter . '" class="tab-pane fade">';
                }
                if ($file->type == 'image') {
    ...
    if(isset($node->field_images_and_videos['und'])) {
        foreach ($node->field_images_and_videos['und'] as $img_content) {
            ...
            if ($file->type == 'image') {
                echo '<a data-toggle="tab" href="#image-area_' . $r . '_' . $counter . '">';
                ...
                $file_tname .= '.jpg';
                echo '<a  class="video"  data-toggle="tab" href="#image-area_' . $r . '_' . $counter . '">';
